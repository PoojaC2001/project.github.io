...
<head>
	...
	<tr>
		<td><?php echo $a; ?></td>
			...
			<td>
            <a href="uploadq3/<?php echo $files[$i] ?>"><?php echo $files[$i] ?></a>
            </td>
            <td>
            <a href="deletequiz3.php?fname='<?php echo $files[$i] ?>'"><button style="background-color:red; border-color:green; border-width:4px; color:white;">Delete</button></a>
		<?php  
		} 
        ?>
        </tr>

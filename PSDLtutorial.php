...
<head>
	...
	<tr>
		<td><?php echo $a; ?></td>
			...
			<td>
            <a href="uploadt9/<?php echo $files[$i] ?>"><?php echo $files[$i] ?></a>
            </td>
            <td>
            <a href="deletetutorial9.php?fname='<?php echo $files[$i] ?>'"><button style="background-color:red; border-color:green; border-width:4px; color:white;">Delete</button></a>
		<?php  
		} 
        ?>
        </tr>

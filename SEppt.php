...
<head>
	...
	<tr>
		<td><?php echo $a; ?></td>
			...
			<td>
            <a href="uploadp8/<?php echo $files[$i] ?>"><?php echo $files[$i] ?></a>
            </td>
            <td>
            <a href="deleteppt8.php?fname='<?php echo $files[$i] ?>'"><button style="background-color:red; border-color:green; border-width:4px; color:white;">Delete</button></a>
		<?php  
		} 
        ?>
        </tr>

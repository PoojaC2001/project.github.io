    ...
    extract($_POST);
        ...
        if(isset($upload))
        {
            ...
            elseif($p==$pass)
            {
                ...
                $file_store="uploadq10/".$file_name;
...
<head>
	...
	<tr>
		<td><?php echo $a; ?></td>
			...
			<td>
            <a href="uploadq10/<?php echo $files[$i] ?>"><?php echo $files[$i] ?></a>
            </td>
            <td>
            <a href="deletequiz10.php?fname='<?php echo $files[$i] ?>'"><button style="background-color:red; border-color:green; border-width:4px; color:white;">Delete</button></a>
		<?php  
		} 
        ?>
        </tr>
